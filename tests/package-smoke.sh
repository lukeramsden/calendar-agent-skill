...
npm install --prefix "$WORK/install" --ignore-scripts "$PWD/$PACKAGE" >/dev/null
...
printf '%s\n' 'Packed npm install, setup, doctor, source sync, FTS and agenda: passed'
